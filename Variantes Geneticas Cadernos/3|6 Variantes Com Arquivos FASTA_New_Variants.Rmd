...
ProjectDirectory=~/Desktop/Gepoliano/SARS-CoV_2_Regions_Analysis
Regiao=london #London
...
for fasta_file in $(cat $ProjectDirectory/COVID_List_Region.txt); do
  ...
  $REFERENCE \
  $ProjectDirectory/fasta/$Regiao/$fasta_file  > \
  $ProjectDirectory/alignment/$Regiao/$fasta_file".sam"
...
```{bash}
cd ~/Desktop/Gepoliano/SARS-CoV_2_Regions_Analysis/SARS-CoV_2_Regions_Analysis

## Store FASTA files
mkdir fasta

## Store alignment files
mkdir alignment_sam
mkdir alignment_bam
```
...
for fasta_file in $(cat $ProjectDirectory/COVID_List_Region.txt); do
  ...
  ~/anaconda3/bin/bwa mem -M -R \
  '@RG\tID:SampleCorona\tLB:sample_1\tPL:ILLUMINA\tPM:HISEQ\tSM:SampleCorona' \
  ~/Desktop/Gepoliano/CoronaVirus/genome_assemblies/ncbi_genomes_2020_03_21/GCF_009858895_2_ASM985889v3_genomic.fna \
  ~/Desktop/Gepoliano/SARS-CoV-2_Regions/fasta/london/$fasta_file  > \
  ~/Desktop/Gepoliano/SARS-CoV-2_Regions/alignment/london/$fasta_file".sam"
  
  
  ## SAM to BAM
  samtools view -S -b ~/Desktop/Gepoliano/SARS-CoV-2_Regions/alignment/london/$fasta_file".sam" > \
  ~/Desktop/Gepoliano/SARS-CoV-2_Regions/alignment_sam/london/$fasta_file".bam"
done
```
